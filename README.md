...
1. **Gate screen first.** Pending tests, recent hospitalization/surgery, active uninvestigated symptoms,
   ...
   matter more than the known history. An applicant outside a carrier's **published issue-age range** (Banner
   70, Foresters 80, Transamerica 85, F&G Quantum 0-60, F&G Pathsetter 0-80, American Amicable term lane 75,
   John Hancock 20-60, Americo 40-85, Corebridge 50-80 — minimum and maximum) is
   reported as an eligibility decline — "outside published issue ages" — instead of fabricating a class from
   data never published for that age. Gate lists are deduplicated per condition — a condition's published
...
| **Foresters** (secondary) | Preferred Plus / Preferred / Standard Plus / Standard NT, Tobacco Plus, age-band BP & cholesterol ceilings, build charts, family-history and driving rules, non-medical eligibility screens and impairment declines. **PlanRight whole-life lane** (Medical Reference Guide 503461 US 11/19): own min/Preferred/Standard/Basic build chart (declined outside it); any history of CHF — regardless of when — not eligible; nephropathy or neuropathy + diabetes medications within 2 years → Basic death benefit; List A (ACE/ARB) + B (beta-blocker) + C (diuretic) simultaneously → no coverage | *Underwriting Guide — Your Term, Advantage Plus II, Strong Foundation and SMART UL*, 506305 US (04/26); *PlanRight Medical Reference Guide* 503461 US (11/19) |
| **Transamerica** (secondary) | Trendsetter Super / Trendsetter LB, FFIUL II/IUL, FCIUL II/IUL: Preferred Plus/Preferred Elite, Preferred, Standard Plus, Standard NT + tobacco equivalents; sex-neutral blended BMI chart (age bands, Table A–H, decline ≤16/>46); age-band BP & cholesterol/HDL ceilings; driving, family-history and substance tiers; impairment-table declines. **Final Expense Solutions lane** (Immediate / 10-Pay / Easy Solution, ages 0-85, $1K-$50K by age band): Preferred / Standard / Graded / Decline — no table ratings; nicotine within 12 months → tobacco rating; Adult Single Condition Decision Chart screens; build chart min (BMI>18.5) / Preferred (BMI<40) / Standard (BMI<45) / Graded (BMI<48), above graded = no coverage; Activity Credit (3+ days/week exercise) improves build-only Standard → Preferred | *A Field Guide to Underwriting* (Trendsetter Super/LB, IULs), 03/25; *Live Smart Final Expense Solutions Product Rate and Underwriting Guide* (08/2023) |
...
| **American Amicable** (secondary) | Express Term & Term Made Simple simplified-issue term, plus the Dignity Solutions final-expense lane (ages 50-85) and the Home Certainty mortgage-protection term lane (ages 20-75, $25K-$300K, current mortgage required, shares the Express Term build family): Preferred Non-Tobacco (no tobacco/nicotine 36 mo) / Standard Non-Tobacco (12 mo) on an **accept/reject basis** — no table ratings (a Table 1-4 risk issues at Standard rates; above Table 4 is not eligible); build chart with minimum / Table-2 / Table-4 maximums plus a separate Preferred (unisex) chart; BP & cholesterol evaluated via the impairment guide's medication-history rules (no preferred thresholds published); diabetes declines on insulin, tobacco within 12 mo, onset <35, or complications; decline list (heart disease, stroke, COPD, cancer within 8 yr, HIV, dementia, cirrhosis, kidney failure, transplant, paralysis, criminal history within 5 yr, uncontrolled BP); evidence = simplified application + MIB + prescription (pharmaceutical) facility check + MVR, telephone interview by age/amount; Dignity lane plan tier set by eight health questions (a yes to questions 1-3 = no coverage) | *Express Term Agent Guide* 3405 (12/24), *Term Made Simple Agent Guide* (1/25), *Dignity Solutions Agent Guide* (12/24), *Express Term Prescription Reference Guide* |
| **John Hancock** (secondary) | Simple Term with Vitality (simplified term, ages 20-60, up to $500K, no replacement of in-force coverage): Preferred / Standard / Select classes; build ceiling at BMI 43 (BMI 39 for people living with diabetes) — above the chart is not eligible; disqualifiers (DUI/DWI within 5 yr, suspended license within 12 mo, permanent disability, any criminal record, disqualifying occupations); medical disqualifiers (HIV, dementia, coronary/vascular disease, PVD, cancer except BCC/SCC/Stage 0 melanoma, COPD, cirrhosis, kidney disease, neurological disease, psychosis/schizophrenia/attempted suicide, transplant, diabetes with complications, pending diagnostic testing); any nicotine/tobacco/cessation product within 12 mo → tobacco class; underwritten from the application + MIB/MVR/prescription-history/identification checks | *Simple Term with Vitality Underwriting Guide*, LIFE-9415 (4/23) |
| **Americo** (secondary) | Eagle Select 1 / 2 / 3 final expense whole life (ages 40-85, $5K-$40K / $25K ES3): single build range per height; non-nicotine requires 24 mo without nicotine products; knock-out conditions (transplant, MS, systemic lupus, ALS, Alzheimer's/dementia, Huntington's, brain tumor, Parkinson's, amputation due to disease, liver disease, leukemia); 12-month declinables (ADL assistance, hospice, oxygen, wheelchair dependence, pending tests/hospitalization); tier logic (heart disease/diabetes/stroke-TIA/PVD/respiratory + nicotine → Eagle Select 2; any 2 of heart/diabetes/stroke-TIA non-nicotine → ES2; diabetes complications → ES2); Quit Smoking Advantage (smokers get non-nicotine rates for the first 3 policy years); 100% instant-decision eApplication with MIB + prescription + third-party data | *Eagle Select Final Expense Agent Guide* 24-275-1 (03/25), *Eagle Select Underwriting Tips* 24-275-5 (11/24) |
| **Quility Term Plus** (secondary) | Legal & General America simplified term (issued by Banner Life; not available in NY): Preferred Plus / Preferred / Standard Plus / Standard — **no table ratings** (above Standard is declined); four-column build chart with min weights and the half-of-intentional-weight-loss rule; accepted conditions (RA, UC, BCC/SCC skin cancer, asthma ≤1 med, a-fib post-ablation, sleep apnea, aviation, scuba ≤100 ft, marijuana at non-tobacco rates, anxiety/depression/PTSD ≤1 med, diabetes A1c <8 non-insulin diagnosed >40, hyperlipidemia ≤2 meds, hypertension ≤2 meds, MS, seizures, hypothyroidism); declinables (any cancer in 10 yr, HIV ever, liver/pancreatic disease, CAD/angioplasty/cardiomyopathy, stroke, bipolar, substance abuse in 10 yr, felony/probation, BMI <18 or >43, >4 violations, DUI within 2 yr); instant decisions for ~70% of applicants | *Quility Term Plus Underwriting Guide* (effective 11/2024) |
| **Corebridge / AGL** (secondary) | SimpliNow Legacy simplified issue whole life (ages 50-80, instant decisions, no underwriters) + American General GIWL guaranteed-issue lane (ages 50-80, $5K-$25K, no health questions): Level benefit (SimpliNow Legacy Max) / Graded benefit (110% of premiums paid years 1-2, full face after two years); build chart (min-max weight per height); condition table assigns Level / Graded / Decline by condition and time frame (Stage I cancers 48 mo → level; MS/Parkinson's/Stage II → graded; most cancers within 24 mo, stroke within 12 mo, diabetes A1c 10+, HIV, dementia, organ transplant, cirrhosis, renal failure → decline); prescription list flags medications that impact the death benefit (Plavix, Entresto, Aricept, Suboxone, opioids, etc. → decline); US citizens/green card holders only | *SimpliNow Legacy SIWL Underwriting Guide* AGLC201453 (04/24), *GIWL Agent Guide* AGLC200472 (12/24) |
