...
1. **Applicant** — carrier (Banner Life, Foresters, Transamerica, Mutual of Omaha, F&G Quantum, F&G Pathsetter, National Life Group, or American Amicable), age, sex, state, occupation, hazardous duties, plus aviation exposure, hazardous sports, frequent foreign travel, military service (combat → MH/TBI screening note), and foreign-residence history (6+ months → eligibility-review flag)
...
1. **Gate screen first.** Pending tests, recent hospitalization/surgery, active uninvestigated symptoms,
   ...
   matter more than the known history. An applicant above a carrier's **published maximum issue age** (Banner
   70, Foresters 80, Transamerica 85, F&G Quantum 60, F&G Pathsetter 80, American Amicable term lane 75) is
