...
add("Banner COPD oxygen treatment + oxygen-use form flag -> single oxygen_use decline, no duplicate copd_recent postpone", d => {
  d.conditions = [{ id: "copd", status: "current", severity: "mild", control: "good", treatment: "oxygen" }];
  d.oxygenUse = true;
}, { klass: "decline", tobacco: false, wantPostponeGates: 0, wantDeclineGates: 1 });
